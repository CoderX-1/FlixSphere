        ...
        {loading ? (
          ...
          <CardFooter className="items-start flex-col overflow-hidden bottom-5 xs:bottom-10 py-1 absolute z-10 gap-1 sm:gap-2">
            ...
            <div className="text-xs 2xl:text-sm tracking-wider text-white/90 flex gap-3 ">
              <span className="flex items-center gap-1 rounded-md bg-gray-400 h-4 w-12"></span>
              <span className="flex gap-1 bg-gray-400 h-4 w-16"></span>
              <span className="flex items-center gap-1 bg-gray-400 h-4 w-20"></span>
            </div>
            <p className="leading-tight text-md !line-clamp-2 !md:line-clamp-3 lg:leading-snug sm:w-9/12 lg:w-3/6 w-full md:text-lg lg:text-xl bg-gray-400 h-16 mt-2 rounded"></p>
            <div className="flex mt-1 sm:mt-4 gap-2">
              <div className="bg-gray-400 h-10 w-32 md:w-40 rounded-md"></div>
              <div className="bg-gray-400 h-10 w-24 rounded-md"></div>
            </div>
          </CardFooter>
        </Card>
        ) : (
              ...
              <CardFooter className="items-start flex-col overflow-hidden bottom-5 xs:bottom-10 py-1 absolute z-10 gap-1 sm:gap-2">
                ...
                <div className="text-xs 2xl:text-sm tracking-wider text-white/90 flex gap-3 ">
                  ...
                  <span className="flex items-center gap-1 ">
                    <span className="uppercase">{randomMovie.original_language}</span>
                    <span>•</span>
                    <span>HD</span>
                  </span>
                </div>

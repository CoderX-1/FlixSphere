        ...
        <div className="flex flex-wrap justify-between items-center gap-2 md:gap-0">
          ...
          <div className="w-full md:w-1/3 text-center md:text-right">
            ...
            <div className="flex justify-center md:justify-end space-x-4 mt-2">
              <a href="https://t.me/FlixSphere" target='_blank' className="flex gap-1 text-gray-400 hover:text-white transition-colors duration-300">
              ...
              <a href="https://discord.gg/ckvEqSCzFW" target='_blank' className="flex gap-1 text-gray-400 hover:text-white transition-colors duration-300">

            ...
            {results.length === 0 ? (
              ...
              <div className="flex overflow-x-auto no-scrollbar-atAll flex-wrap">
                {results.map((result) => (
                  <Link
                    key={result.id}
                    className="relative flex p-[.5rem] mb-2 flex-col group gap-2 w-1/2 sm:w-1/3 md:w-1/4 lg:w-1/6 xl:w-1/7  rounded-lg flex-shrink-0 group cursor-pointer hover:transform hover:scale-100 transition-transform duration-300 ease-in-out"

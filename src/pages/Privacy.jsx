    ...
    <div className="bg-[#111111] text-white min-h-screen mt-8">
      ...
      <div className="container mx-auto px-6 py-12">
        ...
        <div className="bg-white text-gray-900 shadow-lg rounded-lg p-8">
          <p className="mb-6">
            At watch.lonelil.com, accessible from <a href="https://watch.lonelil.com" className="text-blue-500 hover:underline">https://watch.lonelil.com</a>, safeguarding the privacy of our visitors is one of our top priorities. This Privacy Policy outlines the types of information that are collected and recorded by watch.lonelil.com and how we use this information.
          </p>
          <p className="mb-6">
          ...
          <p className="mb-6">
            watch.lonelil.com uses log files as part of a standard procedure for hosting services' analytics. These files log visitors when they visit websites. The information collected by log files includes internet protocol (IP) addresses, browser type, Internet Service Provider (ISP), date and time stamp, referring/exit pages, and possibly the number of clicks. This information is not linked to any personally identifiable information. The purpose of collecting this information is to analyze trends, administer the site, track users' movement on the website, and gather demographic information.
          </p>

          <h2 className="text-3xl font-bold mt-10 mb-4">Cookies and Web Beacons</h2>
          <p className="mb-6">
            Like many other websites, watch.lonelil.com uses "cookies" to store information about visitors' preferences and the pages on the site that the visitor accessed or visited. This information is used to optimize the users' experience by customizing our web page content based on visitors' browser type and/or other information.
          </p>

          <h2 className="text-3xl font-bold mt-10 mb-4">Google DoubleClick DART Cookie</h2>
          <p className="mb-6">
            Google is a third-party vendor on our site and uses cookies, known as DART cookies, to serve ads to our site visitors based upon their visit to watch.lonelil.com and other sites on the internet. Visitors can opt out of the use of DART cookies by visiting the Google ad and content network Privacy Policy at the following URL: <a href="https://policies.google.com/technologies/ads" className="text-blue-500 hover:underline">https://policies.google.com/technologies/ads</a>.
          </p>
          ...
          <p className="mb-6">
            Thank you for visiting watch.lonelil.com. Your privacy is important to us, and we are committed to protecting the information you share with us.
          </p>
        </div>
      </div>
      <Footer />
